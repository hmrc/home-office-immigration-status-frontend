...
import uk.gov.hmrc.homeofficeimmigrationstatus.journeys.HomeOfficeImmigrationStatusFrontendJourneyModel.State._
import uk.gov.hmrc.homeofficeimmigrationstatus.journeys.HomeOfficeImmigrationStatusFrontendJourneyModel.Transitions._
import uk.gov.hmrc.homeofficeimmigrationstatus.journeys.HomeOfficeImmigrationStatusFrontendJourneyModel.{State, Transition, TransitionNotAllowed}
import uk.gov.hmrc.homeofficeimmigrationstatus.models._
import uk.gov.hmrc.homeofficeimmigrationstatus.services.HomeOfficeImmigrationStatusFrontendJourneyService
import uk.gov.hmrc.homeofficeimmigrationstatus.support.{InMemoryStore, StateMatchers}
...
>>>>>>> HOSS2-149 - Update all references of settled status to immigration status:test/uk/gov/hmrc/homeofficeimmigrationstatus/journey/HomeOfficeImmigrationStatusFrontendModelSpec.scala
  ...
  case class given(initialState: State)
      extends HomeOfficeImmigrationStatusFrontendJourneyService[DummyContext]
